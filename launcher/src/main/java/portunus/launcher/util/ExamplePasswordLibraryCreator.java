...
/**
 * Creates an exemplary password library for testing purposes.
 */
public class ExamplePasswordLibraryCreator {
    /**
     * Creates an exemplary password library for testing purposes.
     *
     * @param factory The factory to use for creating the model elements
    ...
    private static IPasswordRecord createPasswordRecord(IPortunusFactory factory, String title, String user,
                                                        String password) {
        IPasswordRecord passwordRecord = factory.createPasswordRecord(title);

        passwordRecord.setUser(user); passwordRecord.setPassword(password);
