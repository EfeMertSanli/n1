...
/**
 * The context menu for a password record table view.
 */
public class PasswordRecordTableViewContextMenu extends ContextMenu {
    ...
    private void initializeControl() {
        copyUserMenuItem = createAndAddMenuItem("Copy User to Clipboard",
                ImageLibrary.getInstance().getCopyUserImage());
        copyUserMenuItem.setAccelerator(new KeyCodeCombination(KeyCode.B, KeyCombination.CONTROL_DOWN));

        copyPasswordMenuItem = createAndAddMenuItem("Copy Password to Clipboard",
                ImageLibrary.getInstance().getCopyPasswordImage());
        ...
        addPasswordRecordMenuItem = createAndAddMenuItem("Add Record...",
                ImageLibrary.getInstance().getAddPasswordRecordImage());
        editPasswordRecordMenuItem = createAndAddMenuItem("Edit/View Record...",
                ImageLibrary.getInstance().getEditPasswordRecordImage());
        deletePasswordRecordMenuItem = createAndAddMenuItem("Delete Record",
                ImageLibrary.getInstance().getDeletePasswordRecordImage());
    }
