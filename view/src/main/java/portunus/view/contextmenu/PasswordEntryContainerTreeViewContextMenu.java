...
/**
 * The context menu for a password entry container tree view.
 */
public class PasswordEntryContainerTreeViewContextMenu extends ContextMenu {
    ...
    private void initializeControl() {
        addPasswordGroupMenuItem = createAndAddMenuItem("Add Group...",
                ImageLibrary.getInstance().getAddPasswordGroupImage());
        editPasswordGroupMenuItem = createAndAddMenuItem("Edit Group...",
                ImageLibrary.getInstance().getEditPasswordGroupImage());
        deletePasswordGroupMenuItem = createAndAddMenuItem("Delete Group",
                ImageLibrary.getInstance().getDeletePasswordGroupImage());
    }
