...
public class PasswordRecordTableView extends TableView<IPasswordRecord> {
    ...
    private <T> TableColumn<IPasswordRecord, T> addColumn(String name, int preferredWidth,
                                                          CellValueFactory<IPasswordRecord, T> cellValueFactory) {
